        ...
        <div class="row justify-content-between">
            ...
            <div class="col-xl-3 col-sm-7 col-md-6 col-lg-3">
                <div class="wsus__footer_content">
                    <a class="wsus__footer_2_logo footer_text_logo" href="#">
                        Tofu Corner
                    </a>

                    <a class="action" href="callto:+8896254857456">
                        <i class="fas fa-phone-alt"></i> 01641902311
                    </a>

                    <a class="action" href="mailto:rahman@gmail.com">
                        <i class="far fa-envelope"></i> rahman@gmail.com
                    </a>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="wsus__copyright d-flex justify-content-center">
                        <p>Copyright © 2026 Tofu Corner. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
